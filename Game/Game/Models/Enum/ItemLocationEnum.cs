namespace Game.Models
{
    public enum ItemLocationEnum
    {
        ...
        // The head includes, Hats, Helms, Caps, Crowns, Hair, and anything else that sits on the head
        Head = 10,

        // Things to put around the neck, such as neckless, broaches, scarfs, neck ribbons.  Can have at the same time with Head items ex. Ribbon for Hair, and Ribbon for Neck is OK to have
        Necklass = 12,

        // The primary hand used for fighting with a lightsaber.  
        PrimaryHand = 20,

        // The second hand used for holding a shield or using the force.
        OffHand = 22,

        // Any finger, used for rings, because they can go on any finger.
        Finger = 30,

        // A finger on the Right hand for rings.  Can only have one ring on the right hand.
        RightFinger = 31,
